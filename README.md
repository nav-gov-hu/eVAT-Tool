...
Fontosnak tartjuk, hogy az eÁFA rendszer használatához minél több integrációs segítséget adjunk az adózóknak. 
A NAV elkészített egy olyan konvertáló eszközt, amely segítségével egy kitöltött sablon excel táblából az adózók könnyebben elő tudnak állítani egy eÁFA analitika XMl-t ami az eÁFA rendszer fel tud dolgozni.

## A tárhely tartalma és célja

A tárhely a NAV eÁFA Tool, valamint az azzal kapcsolatos információk publikus megosztásának a helye. A tárhely elsősorban az eÁFA tool-lal kapcsolatban felmerülő javaslatok, ötletek megosztásának közösségi terét jelenti. 
...
Kérjük figyelembe venni, hogy bár a tárhely publikusan elérhető, a véleményezéshez illetve  és a fejlesztéshez hozzájáruláshoz GitHub userre van szükség. A felhasználó ingyenesen, pár perc alatt létrehozható. A felmerült kérdéseket, javaslatokat a https://github.com/nav-gov-hu/eVAT-Tool/discussions oldalon kérjük megtenni az alábbiak szerint:
